...
```
C:\Users\<you>\OneDrive\Documents\7. Software\PKM\metis\
```
...
```bash
cd "/mnt/c/Users/<you>/OneDrive/Documents/7. Software/PKM/metis/08_system/mcp-server"
...
```json
{
  "mcpServers": {
    "metis-pkm": {
      ...
      "args": [
        "bash",
        "/mnt/c/Users/<you>/OneDrive/Documents/7. Software/PKM/metis/08_system/mcp-server/run_mcp_server.sh"
      ],
      "env": {
        "METIS_RC_ROOT": "/mnt/c/Users/<you>/OneDrive/Documents/7. Software/PKM/metis"
      }
    }
  },
  "preferences": {
...
```
C:\Users\<you>\OneDrive\Documents\7. Software\PKM\metis\07_outputs\apps\metis-dashboard\launch_metis.bat
```
