...
- Deleted `05_sources/code/swarm-runner-reference/`
...
**Launcher & shortcut**
- `launch_metis.bat` — renamed launcher (parallel to old `launch_legacy.bat`)
...
**Full approved plan:** `/home/<user>/.claude/plans/squishy-dazzling-dragonfly.md`
