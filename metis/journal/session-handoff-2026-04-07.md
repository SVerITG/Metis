...
```json
{
  "mcpServers": {
    "metis-pkm": {
      "command": "/mnt/c/Users/<user>/OneDrive/Documents/7. Software/PKM/metis/08_system/mcp-server/.venv/bin/metis-mcp",
      "env": {
...
```bash
/mnt/c/Users/<user>/OneDrive\ -\ ITG/Documents/7.\ Software/PKM/metis/08_system/mcp-server/.venv/bin/metis-mcp --help
```
