...
|---|---|---|
| **Full visual spec for Claude Design** | `/home/<user>/.claude/plans/nifty-stargazing-sifakis.md` | Part 1 has the complete design language — palette tokens, typography scale, layout ASCII diagram, component specs. **Keep this intact.** |
...
/home/<user>/.claude/plans/nifty-stargazing-sifakis.md      # full visual spec
