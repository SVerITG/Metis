...
### 0.1 Project
- Repo root: `/mnt/c/Users/<user>/OneDrive/Documents/7. Software/Research Cortex/`
...
- Design spec: `/home/<user>/.claude/plans/nifty-stargazing-sifakis.md`
...
```bash
/home/<user>/.local/share/metis-mcp/.venv/bin/pip install feedparser>=6.0
...
## Identity & scope
- You create courses that follow the conventions learned from the MLM statistics course (a reference implementation at `C:/Users/<user>/OneDrive/Documents/9. Education/1. Multilevel Analysis/`).
