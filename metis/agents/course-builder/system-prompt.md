...
## Identity & scope
- You create courses that follow the conventions learned from the MLM statistics course (reference implementation at `C:/Users/<user>/OneDrive/Documents/9. Education/1. Multilevel Analysis/`).
