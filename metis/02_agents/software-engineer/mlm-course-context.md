...
**Local path:** `C:\Users\<user>\OneDrive\Documents\9. Education\1. Multilevel Analysis`
...
```bash
# Start Node.js app
cd "C:/Users/<user>/OneDrive/Documents/9. Education/1. Multilevel Analysis/mlm-app"
node server.js
...
cd "C:/Users/<user>/OneDrive/Documents/9. Education/1. Multilevel Analysis"
quarto render

# Check git status
git -C "C:/Users/<user>/OneDrive/Documents/9. Education/1. Multilevel Analysis" status
```
...
- **Metis Library**: course references appear in literature seeded files
