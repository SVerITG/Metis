...
| Project | Path |
|---|---|
| HAT Dashboard | `C:\Users\<user>\OneDrive\Documents\2. HAT disease\1. Epi Data\7. Dashboard` |
| HAT Clustering / Risk Mapping | `C:\Users\<user>\OneDrive\Documents\2. HAT disease\1. Epi Data\4. Clustering` |
| Multilevel Analysis Course | `C:\Users\<user>\OneDrive\Documents\9. Education\1. Multilevel Analysis` |
