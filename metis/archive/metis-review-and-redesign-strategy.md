...
**Header row.** Left side: the greeting strip ("Good morning, the researcher — Friday 10 April 2026"). Right side: the trust badge (green shield, "Local-first, 2 external calls today") and the Ctrl+K quick-capture button. These two elements never move; they follow the researcher into every tab so she can capture or check trust status from anywhere.
