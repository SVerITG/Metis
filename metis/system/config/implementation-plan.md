...
- [x] **M — .gemini/GEMINI.md** — DONE 2026-05-12  
  `.gemini/GEMINI.md` created: full agent routing table, the researcher's profile, key paths, standing rules,  
...
- [ ] **M — Mobile PWA capture page**  
  ...
  *Simpler than Telegram if the researcher already has Tailscale installed.*
