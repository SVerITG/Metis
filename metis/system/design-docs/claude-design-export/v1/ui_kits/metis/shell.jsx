...
const NAV_TITLES = {
  today:     { eyebrow: 'Thursday · 14 November · 07:12', title: 'Good morning, the researcher.', accent: 'em' },
  ...
  return (
    <aside className="side">
      ...
      <div className="side-foot">
        ...
        <span>the researcher · Reader in residence</span>
      </div>
    </aside>
  );
}
  ...
  return (
    <div className="page-head">
      <div>
        ...
        <h1>{t.accent === 'em' ? <>Good morning, <em>the researcher.</em></> : t.title}</h1>
      </div>
      {right}
    </div>
  );
