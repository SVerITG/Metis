        ...
        <div>
          ...
          <div className="panel" style={{ padding: '18px 22px', marginBottom: 24 }}>
            <div style={{ display:'flex', alignItems:'center', gap:16 }}>
              ...
              <div>
                <div style={{ fontFamily:'var(--m-display)', fontSize:17, color:'var(--m-ink)' }}>the researcher</div>
                <div style={{ fontFamily:'var(--m-display)', fontStyle:'italic', fontSize:13, color:'var(--m-muted)' }}>the researcher@metis.local · reader in residence since June 2024</div>
              </div>
