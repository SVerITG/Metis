...
This project is the canonical design system for **Metis** — a personal knowledge-work companion for one reader (the researcher). Nine connected surfaces: Today, Knowledge, Thinking, Planner, Work, Meetings, Learning, Teach, Metis.
