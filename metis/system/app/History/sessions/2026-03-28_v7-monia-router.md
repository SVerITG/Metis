...
| 02_agents/metis/contract.md | MODIFIED | Rewrite: Metis now explicitly owns routing decisions, complexity assessment, and PKM recording; added complexity table with model hints; added recording mandate |
