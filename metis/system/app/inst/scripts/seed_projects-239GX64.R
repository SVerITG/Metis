...
db_path <- here::here("data", "metis.sqlite")
...
projects <- data.frame(
  ...
  external_path = c(
    "C:\\Users\\<user>\\OneDrive\\Documents\\2. HAT disease\\1. Epi Data\\7. Dashboard",
    "C:\\Users\\<user>\\OneDrive\\Documents\\2. HAT disease\\1. Epi Data\\4. Clustering",
    "C:\\Users\\<user>\\OneDrive\\Documents\\9. Education\\1. Multilevel Analysis"
  ),
  github_url    = c(
...
extra_tasks <- data.frame(
  ...
  notes = c(
    ...
    "Security rule: aggregate display only — no patient-level records. See metis/security-policy.md",
...
reactive_agent_tasks <- data.frame(
  ...
  notes = c(
    "Consider: local MCP server exposing metis.sqlite queries to Claude Code. See swarm-runner-reference for MCP patterns.",
