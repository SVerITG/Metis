...
start "" wsl.exe -d Ubuntu-24.04 -- bash -c "cd '/mnt/c/Users/<user>/OneDrive/Documents/7. Software/Research Cortex/metis/system/app-py' && METIS_RC_ROOT='/mnt/c/Users/<user>/OneDrive/Documents/7. Software/Research Cortex/metis' PYTHONPATH='/home/<user>/.local/share/metis-mcp/.venv/lib/python3.12/site-packages' /usr/bin/python3.12 -m uvicorn main:app --host 127.0.0.1 --port 8000 2>&1 &"
