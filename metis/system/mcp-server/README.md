...
```json
{
  "mcpServers": {
    "metis-rc": {
      ...
      "args": [
        "bash",
        "/mnt/c/Users/<user>/OneDrive/Documents/7. Software/PKM/metis/08_system/mcp-server/run_mcp_server.sh"
      ],
      "env": {
        "METIS_RC_ROOT": "/mnt/c/Users/<user>/OneDrive/Documents/7. Software/PKM/metis"
      }
    }
  }
}
