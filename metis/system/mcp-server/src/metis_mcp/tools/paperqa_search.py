"""PaperQA2 — semantic PDF search over the researcher's library.
...
async def index_library_pdfs(
    ...
    """Build or rebuild a PaperQA2 index over the researcher's PDF library.
...
async def ask_library(
    ...
    """Answer a question using the researcher's indexed PDF library via PaperQA2.
