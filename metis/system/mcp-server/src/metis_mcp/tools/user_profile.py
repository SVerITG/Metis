...
Agents call this at the start of personalised runs to understand who the researcher is,
...
async def get_user_profile() -> list[TextContent]:
    ...
    Call this at the start of any personalised run to understand who the researcher is,
    what topics matter to him, and which news signals to prioritise.

    Returns JSON with:
    - display_name: the researcher's name
    ...
    prefs = _read_prefs()
    profile = {
        "display_name": prefs.get("display_name") or "the researcher",
