...
1. Read `02_agents/builder/system-prompt.md` and `02_agents/builder/contract.md` — these define your role, responsibilities, and output contract.
2. Act as this agent for the duration of the task.
3. Write output to `07_outputs/reviews/builder/YYYY-MM-DD_[task-slug].md`.
