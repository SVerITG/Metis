...
- Read the project's `PLANNING.md` via `read_file(path)`:
  - HAT Dashboard: `/mnt/c/Users/<user>/OneDrive/Documents/2. HAT disease/1. Epi Data/7. Dashboard/PLANNING.md`
  - HAT Clustering: `/mnt/c/Users/<user>/OneDrive/Documents/2. HAT disease/1. Epi Data/4. Clustering/PLANNING.md`
  - MLM Course: `/mnt/c/Users/<user>/OneDrive/Documents/9. Education/1. Multilevel Analysis/PLANNING.md`
