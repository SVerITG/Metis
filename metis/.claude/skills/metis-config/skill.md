...
Run:
```bash
cd "/mnt/c/Users/$(whoami)/OneDrive/Documents/7. Software/Research Cortex/metis/08_system/mcp-server"
python3 -m venv .venv
...
- If yes, run the shortcut creator:
  ...
  powershell.exe -ExecutionPolicy Bypass -File \
    "$(wslpath -w "/mnt/c/Users/$(whoami)/OneDrive/Documents/7. Software/Research Cortex/metis/07_outputs/apps/metis-dashboard/create_shortcut.ps1")"
  ```
