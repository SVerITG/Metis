...
def run_dashboard_v2():
    ...
    # DV22 — user-config.yaml has name: the researcher (not placeholder)
        ...
        if name_match:
            ...
            if name_val in ("Researcher", "Amélie", "User", ""):
                fail("DV22", "user-config.yaml name is set (not placeholder)", "Dashboard v9e",
                     ...
                     "Update name: the researcher in user-config.yaml.", "Medium")
            else:
            ...
            warn("DV22", "user-config.yaml has name: field", "Dashboard v9e",
                 ...
                 "Add 'name: the researcher' under the [user] section of user-config.yaml.", "Medium")
    else:
