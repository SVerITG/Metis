...
```bash
cd "/mnt/c/Users/<you>/OneDrive - ITG/Documents/7. Software/PKM/metis/system/mcp-server"
...
```json
{
  "mcpServers": {
    "metis-pkm": {
      ...
      "args": [
        "bash",
        "/mnt/c/Users/<you>/OneDrive - ITG/Documents/7. Software/PKM/metis/system/mcp-server/run_mcp_server.sh"
      ],
      "env": {
