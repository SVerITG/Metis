' launch_metis_background.vbs
' Launches the Metis interface silently — no console window.
...
'
' Metis available at: http://localhost:3838
...
If Not fso.FileExists(launchR) Then
  MsgBox "launch.R not found at: " & launchR, 16, "Metis"
  WScript.Quit
End If
...
If rscript = "" Then
  MsgBox "Rscript.exe not found. Please edit launch_metis_background.vbs with the correct R path.", 16, "Metis"
  WScript.Quit
End If
