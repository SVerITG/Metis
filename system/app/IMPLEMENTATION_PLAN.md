# Metis Dashboard Implementation Plan

## Goal

Build one local-first command-center application that becomes the daily operating surface for Metis and the specialist agents.
...
- Metis reads the dashboard state and open decisions
...
5. add agent-output pages and Metis recommendation logic
