...
| agents/news-aggregator/system-prompt.md | ADDED | RSS aggregator agent system prompt |
| agents/news-aggregator/contract.md | ADDED | Agent contract |
| agents/news-aggregator/README.md | ADDED | Agent README |
| agents/ux-engineer/system-prompt.md | ADDED | UX/design system agent system prompt; hard rules: no emoji icons, WCAG AA, responsive breakpoints |
| agents/ux-engineer/contract.md | ADDED | Agent contract |
| agents/ux-engineer/README.md | ADDED | Agent README |
| agents/epidemiologist/system-prompt.md | ADDED | Senior epi reviewer with Socratic persona; HAT/NTD expertise |
| agents/epidemiologist/contract.md | ADDED | Agent contract |
| agents/epidemiologist/README.md | ADDED | Agent README |
...
| agents/metis/security-policy.md | MODIFIED | 3 rows added to per-agent security table; news-aggregator granted internet access; ux-engineer and epidemiologist assigned no-internet |
