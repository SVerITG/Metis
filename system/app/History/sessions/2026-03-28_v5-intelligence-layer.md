...
| agents/CLAUDE.md | MODIFIED | 3 new agent invocations added: /learning-coach, /career-coach, /personal-finance |
| agents/learning-coach/ | ADDED | New agent directory — system-prompt.md, contract.md, README.md |
| agents/career-coach/ | ADDED | New agent directory — system-prompt.md, contract.md, README.md |
| agents/personal-finance/ | ADDED | New agent directory — system-prompt.md, contract.md, README.md |
...
- [ ] Update security policy (agents/metis/security-policy.md) to include the 3 new agents in the per-agent security table
