...
- The 3 new agents (learning-coach, career-coach, personal-finance) are not yet in the per-agent security table in agents/metis/security-policy.md — this must be updated manually.
