...
**Missing CSS custom properties in `/mnt/c/Users/<user>/.../app-py/static/styles.css`:**
```css
...
The following CSS changes should be made to `/mnt/c/Users/<user>/OneDrive/Documents/7. Software/Research Cortex/metis/system/app-py/static/styles.css` at the start of the session to unify the token system:
...
2. **Static files**: Copy `v2-remix/assets/metis-mark.svg`, `metis-wordmark.svg`, `metis-compass.svg` to `/mnt/c/Users/<user>/OneDrive/Documents/7. Software/Research Cortex/metis/system/app-py/static/`.
