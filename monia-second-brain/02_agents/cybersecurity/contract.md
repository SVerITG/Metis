...
The Cybersecurity Agent is the security guardian of the Metis PKM. It protects against internet threats, prompt injection, malicious files, and unauthorized agent behavior.
...
- Network infrastructure (that's outside the PKM)
