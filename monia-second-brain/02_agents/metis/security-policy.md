# Monia System — Security and Data Protection Policy

**Scope:** All agents operating within the Monia second-brain system
**Derived from:** Ruflo v3.5 security module + local-first PKM principles
**Applies to:** Monia, Software Engineer, Dashboard Engineer, Librarian, Meeting Memory, News Radar, and all specialist agents
