...
```json
{
  "mcpServers": {
    "metis-pkm": {
      "command": "metis-mcp",
      "env": {
        "METIS_PKM_ROOT": "/mnt/c/Users/<user>/OneDrive/Documents/0. Personal/X. KPM/monia-second-brain"
      }
    }
  }
}
...
```json
{
  "mcpServers": {
    "metis-pkm": {
      "command": "uv",
      "args": ["run", "--directory", "/mnt/c/Users/<user>/OneDrive/Documents/0. Personal/X. KPM/monia-second-brain/08_system/mcp-server", "metis-mcp"],
      "env": {
        "METIS_PKM_ROOT": "/mnt/c/Users/<user>/OneDrive/Documents/0. Personal/X. KPM/monia-second-brain"
      }
    }
...
```json
{
  "mcpServers": {
    "metis-pkm": {
      "command": "metis-mcp",
      "env": {
        "METIS_PKM_ROOT": "C:\\Users\\<user>\\OneDrive\\Documents\\0. Personal\\X. KPM\\monia-second-brain"
      }
    }
  }
}
