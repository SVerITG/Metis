...
PKM_ROOT = os.environ.get(
    "METIS_PKM_ROOT",
    "/mnt/c/Users/sverschaeve/OneDrive - ITG/Documents/0. Personal/X. KPM/monia-second-brain"
)

SECURITY_DIR = Path(PKM_ROOT) / "08_system" / "security"
LOG_DIR = Path(PKM_ROOT) / "07_outputs" / "reviews" / "data-guardian"
