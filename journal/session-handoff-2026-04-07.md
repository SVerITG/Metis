...
```json
{
  "mcpServers": {
    "metis-pkm": {
      "command": "/mnt/c/Users/sverschaeve/OneDrive - ITG/Documents/7. Software/PKM/metis/system/mcp-server/.venv/bin/metis-mcp",
      "env": {
...
```bash
/mnt/c/Users/sverschaeve/OneDrive\ -\ ITG/Documents/7.\ Software/PKM/metis/system/mcp-server/.venv/bin/metis-mcp --help
```
