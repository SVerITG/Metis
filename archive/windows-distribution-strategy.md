...
**The greeting strip.** At the top, "Good morning, the researcher" with today's date, the weather (optional), and the current PhD week count. This is a small thing but it grounds the researcher: this is her system, personalized for her, not a generic tool.
