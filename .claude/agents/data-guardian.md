...
```
get_agent_context("data-guardian")
```
...
This indirection is deliberate: your real prompt lives in `agents/data-guardian/` and is
...
1. `log_agent_run(agent_slug="data-guardian", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="data-guardian", context="why")`
