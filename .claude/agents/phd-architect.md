...
```
get_agent_context("phd-architect")
```
...
This indirection is deliberate: your real prompt lives in `agents/phd-architect/` and is
...
1. `log_agent_run(agent_slug="phd-architect", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="phd-architect", context="why")`
