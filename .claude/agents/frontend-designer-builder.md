...
```
get_agent_context("frontend-designer-builder")
```
...
This indirection is deliberate: your real prompt lives in `agents/frontend-designer-builder/` and is
...
1. `log_agent_run(agent_slug="frontend-designer-builder", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="frontend-designer-builder", context="why")`
