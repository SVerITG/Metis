...
```
get_agent_context("career-coach")
```
...
This indirection is deliberate: your real prompt lives in `agents/career-coach/` and is
...
1. `log_agent_run(agent_slug="career-coach", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="career-coach", context="why")`
