...
```
get_agent_context("release-coordinator")
```
...
This indirection is deliberate: your real prompt lives in `agents/release-coordinator/` and is
...
1. `log_agent_run(agent_slug="release-coordinator", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="release-coordinator", context="why")`
