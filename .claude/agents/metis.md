...
You are Metis' **Metis** specialist.
...
This indirection is deliberate: your real prompt lives in `agents/metis/` and is
...
1. `log_agent_run(agent_slug="metis", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="metis", context="why")`
