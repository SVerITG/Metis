...
```
get_agent_context("background-maker")
```
...
This indirection is deliberate: your real prompt lives in `agents/background-maker/` and is
...
1. `log_agent_run(agent_slug="background-maker", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="background-maker", context="why")`
