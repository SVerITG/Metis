...
```
get_agent_context("software-engineer")
```
...
This indirection is deliberate: your real prompt lives in `agents/software-engineer/` and is
...
1. `log_agent_run(agent_slug="software-engineer", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="software-engineer", context="why")`
