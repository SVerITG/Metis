...
```
get_agent_context("course-builder")
```
...
This indirection is deliberate: your real prompt lives in `agents/course-builder/` and is
...
1. `log_agent_run(agent_slug="course-builder", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="course-builder", context="why")`
