...
```
get_agent_context("content-harvester")
```
...
This indirection is deliberate: your real prompt lives in `agents/content-harvester/` and is
...
1. `log_agent_run(agent_slug="content-harvester", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="content-harvester", context="why")`
