...
```
get_agent_context("epidemiologist")
```
...
This indirection is deliberate: your real prompt lives in `agents/epidemiologist/` and is
...
1. `log_agent_run(agent_slug="epidemiologist", task_summary="<one line>")`
2. If the researcher stated or confirmed a standing preference — how something
   ...
   next time:
   `record_decision(decision="...", category="...", agent_slug="epidemiologist", context="why")`
