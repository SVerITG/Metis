...
Scaffolds a new project in the Metis RC system from any starting point (idea, data file, conversation, task). Works from Codex and Codex Desktop.
...
- Domain / research link (e.g., "[your domain]", "my-thesis", "general")
