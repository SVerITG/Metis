...
Display the full agent directory with rich descriptions, use cases, and last-run information. Better than the table in AGENTS.md — gives you enough context to pick the right agent without guessing.
