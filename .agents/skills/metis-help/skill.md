...
Provide a friendly, non-technical guide to using Metis — written for researchers who may be new to AI tools and are using Metis through Codex Desktop. No coding knowledge required to understand this.
...
**Metis is your personal research assistant.** She lives inside Codex Desktop and knows your projects, your tasks, your literature, your notes, and your research context. You don't need to explain who you are or what you're working on — she already knows.
...
*Power users: the exhaustive command + agent reference lives in `AGENTS.md` at the Research Cortex root.*
...
- **It's optional:** Everything the dashboard shows, you can also ask Metis directly in Codex Desktop
...
No. Metis is designed to be used entirely through plain conversation in Codex Desktop.
...
Yes. The dashboard is a visual helper, but Metis through Codex Desktop has access to the same information.
...
*Metis is built on Codex by Anthropic. Your research context is managed locally and never sent to the cloud.*
