...
**Local path:** `C:\Users\<user>\OneDrive\Documents\2. HAT disease\1. Epi Data\7. Dashboard`
...
```bash
# Check status
git -C "C:/Users/<user>/OneDrive/Documents/2. HAT disease/1. Epi Data/7. Dashboard" status
